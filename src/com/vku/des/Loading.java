...
public class Loading extends javax.swing.JFrame {
    ...
    class pbThead extends Thread{
        ...
        JProgressBar pbar;
Loading parent; // Tham chiếu đến cửa sổ `Loading`
        pbThead(JProgressBar pbar, Loading parent) {
            this.pbar = pbar;
        ...
        public void run() {
            ...
            TrangChu tc = new TrangChu(); // Tạo cửa sổ mới
